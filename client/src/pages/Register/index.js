...
function Register() {
    ...
    const warnings = {
        ...
        "password": "Min. password length should be 8, including capital letters, numbers and symbols",
                ...
                <form className="form-left" onSubmit={handleSubmit} >
                    ...
                    <div className="name">
                        <div className="ip">
                            ...
                            <input ref={ firstNameField } type="text" id="first-name" className="input-field text" />
                        </div>
                        <div className="ip">
                            <label htmlFor="last-name">Last name</label>
                            <input ref={ lastNameField } type="text" id="last-name" className="input-field text" />
                        </div>
                    </div>
                    <div className="ip">
                        <label htmlFor="email-field">Email</label>
                        <input type="email" ref={ emailField } className="input-field" name="email-box" id="email-field" />
                    </div>
                    <div className="ip">
